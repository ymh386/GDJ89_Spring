	...
	<div class="row col-md-8 offset-md-2">
		...
		<form action="./add" method="post">
		  <div class="mb-3">
		    ...
		    <input type="text" placeholder="제목 입력" name="boardTitle" class="form-control" id="inputBoardTitle">
		  </div>
		  <div class="mb-3">
		    <label for="inputProductDetail" class="form-label">Contents</label>
		    <textarea rows="10" cols="" name="boardContent" class="form-control" id="inputProductDetail"></textarea>
		  </div>
		  <div class="col-md-4">
